...
/**
 * 工作项分配处理器。负责为ActivityInstance创建WorkItem
 * 
 * @author 非也
 * @version 2.0
 */
public interface AssignmentHandler extends Serializable{
    ...
    public List<WorkItem> assign(WorkflowSession session,ActivityInstance activityInstance, ServiceBinding serviceBinding,
