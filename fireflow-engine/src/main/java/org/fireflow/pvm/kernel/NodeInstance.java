 ...
 * @version 2.0
 */
public interface NodeInstance extends PObject {
	////////////////////////////////////////////////////////
	//////////////////   结构抽象        ////////////////////////
	///////////////////////////////////////////////////////
//	public List<ArcInstance> getEnteringArcInstances();
//	public void addEnteringArcInstance(ArcInstance arcInst);
//	
//	public List<ArcInstance> getLeavingArcInstances();
//	public void addLeavingArcInstance(ArcInstance arcInst);
//	
