 ...
 * @version 2.0
 */
public class SequenceTest extends BaseEnviroment4Junit{
	protected static final String processId = "TheSequenceProcess";
		...
		transactionTemplate.execute(new TransactionCallback() {
			public Object doInTransaction(TransactionStatus arg0) {
				...
				process.setStartActivity((new Sequence("Sequence1"))
								.addChild(new EmptyActivity("EmptyActivity_1"))
