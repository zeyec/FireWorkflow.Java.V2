 ...
 * @version 2.0
 */
public class TheDefaultTransitionRouter extends FireWorkflowJunitEnviroment {
	protected static final String processName = "TheDefaultTransitionRouterProcess";
	...
	/**
	 * Start-->Router-default->Activity1-->End1
