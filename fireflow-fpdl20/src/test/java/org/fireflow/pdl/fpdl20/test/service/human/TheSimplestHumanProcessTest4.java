...
/**
 * 从数据库中获取流程定义，从数据库获取服务定义，从数据库中获取资源定义
 * 
 * @author 非也
 * @version 2.0
 */
public class TheSimplestHumanProcessTest4 extends FireWorkflowJunitEnviroment {
	...
	public void testStartProcess() {
		...
		transactionTemplate.execute(new TransactionCallback() {
			public Object doInTransaction(TransactionStatus arg0) {
				...
				try {
					File f = new File(
							"src/test/java/org/fireflow/pdl/fpdl20/test/service/human/TheHumanServices.svc.xml");
				...
				try {
					File f = new File(
							"src/test/java/org/fireflow/pdl/fpdl20/test/service/human/TheParticipants.rsc.xml");
					FileInputStream fIn = new FileInputStream(f);
