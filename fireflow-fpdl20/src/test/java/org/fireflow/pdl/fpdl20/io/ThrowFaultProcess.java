 ...
 * @version 2.0
 */
public class ThrowFaultProcess {
	protected static final String processName = "ThrowFaultProcess";
	protected static final String bizId = "ThisIsAJunitTest";
	
	@Test
	public void testSerialize() {
		try{
			File f = new File("src/test/java/org/fireflow/pdl/fpdl20/io/ThrowFaultProcess.xml");
			if (f.exists()){
				f.delete();
			}
			f.createNewFile();
