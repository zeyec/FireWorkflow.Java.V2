 ...
 * @version 2.0
 */
public class TheConditionSplitOrJoinRouter extends FireWorkflowJunitEnviroment {

	protected static final String processName = "TheConditionSplitOrJoinRouter";
	...
	/**
	 * Start-->Router1--condition1-->Activity1----|
	 *             |--condition2-->Activity2---->Router2-->End
	 */
