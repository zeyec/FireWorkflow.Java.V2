 ...
 * @version 2.0
 */
public class TimerStartDecoratorImpl implements TimerStartDecorator {
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getCronExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getEndTimeExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getRepeatCountExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getRepeatIntervalExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getStartTimeExpression()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getTimerOperationName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getIfCancelAttachedActivity()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#getAttachedActivity()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fireflow.pdl.fpdl20.process.decorator.startnode.TimerStartDecorator#setAttachedActivity(org.fireflow.pdl.fpdl20.process.Activity)
	 */
